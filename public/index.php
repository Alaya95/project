...
<div class="header container">
    ...
    <div class="header__cart">
        ...
        <div class="header__cartProduct">
            ...
            <button class="btn_goCart">Go to cart</button>
...
<div class="topNav container">
    <div class="topNavBlock">
        ...
        <div class="topNavDropdown">
            <div class="topNavDropdownBlock">
                <a href="#" class="topNavDropdownBlockCategory">Women</a>
                ...
                <a href="#">Sweaters/Knits</a>
                <a href="#">Jackets/Coats</a>
                <img src="https://github.com/kellolo/static/blob/master/img/JS1_shop/offer3.jpg?raw=true" alt="itemPhoto">
            </div>
        </div>
    </div>
...
<div class="feature container">
    <div class="feature__sale">
        <div class="feature__sale-text">
    ...
    <div class="subscribe container">
        ...
        <div class="subscribe__blockFeedback">
            ...
            <form action="#" class="subscribeForm">
                ...
                <input id='inputEmail' type="email" name="mail" placeholder="Enter Your Email">
...
<div class="footer">
    <div class="footer__top container">
        ...
        <div class="footer_blockLink">
            <p>Information</p>
            <a href="#" class="footer__link">Tearms & Condition</a>
            <a href="#" class="footer__link">Privacy Policy</a>
            <a href="#" class="footer__link">How to Buy</a>
            <a href="#" class="footer__link">How to Sell</a>
            <a href="#" class="footer__link">Promotion</a>
        </div>
        <div class="footer_blockLink">
            <p>Shop Category</p>
            <a href="#" class="footer__link">Men</a>
            <a href="#" class="footer__link">Women</a>
            <a href="#" class="footer__link">Child</a>
            <a href="#" class="footer__link">Apparel</a>
            <a href="#" class="footer__link">Brows All</a>
        </div>
    </div>
    ...
    <div class="footer__bottom">
        <div class="footerBG container">
            ...
            <div class="footerBGLink">
                ...
                <a href="#" class="socialLink"><i class="fab fa-linkedin-in"></i></a>
                <a href="#" class="socialLink"><i class="fab fa-pinterest-p"></i></a>
                <a href="#" class="socialLink"><i class="fab fa-google-plus-g"></i></a>
            </div>
        </div>
    </div>
